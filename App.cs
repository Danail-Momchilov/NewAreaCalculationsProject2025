...
namespace AreaCalculations2025
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            // 
            PushButtonData smallButton1 = new PushButtonData("About", "A", assembName, "AreaCalculations2025.AboutInfo");
            smallButton1.Image = new BitmapImage(new Uri(path + @"\info.png"));

            PushButtonData smallButton2 = new PushButtonData("Version", "V", assembName, "AreaCalculations2025.VersionInfo");
            smallButton2.Image = new BitmapImage(new Uri(path + @"\version.png"));

            PushButtonData smallButton3 = new PushButtonData("Resources", "R", assembName, "AreaCalculations2025.ResourceInfo");
            ...
            // create PushButon1
            PushButtonData butonData1 = new PushButtonData("Plot\nparameters", "Plot\nparameters", assembName, "AreaCalculations2025.SiteCalcs");
            ...
            // create PushButon 2
            PushButtonData butonData2 = new PushButtonData("Area\ncoefficients", "Area\ncoefficients", assembName, "AreaCalculations2025.AreaCoefficients");
            ...
            // create PushButon 3
            PushButtonData butonData3 = new PushButtonData("Area\ncalculations", "Area\ncalculations", assembName, "AreaCalculations2025.CalculateAreaParameters");
