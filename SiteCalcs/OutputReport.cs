...
namespace AreaCalculations
{
    internal class OutputReport
    {
        ...
        public void updateFinalOutput(List<double> plotAreas, List<string> plotNames, List<double> build, List<double> density, 
            List<double> totalBuild, List<double> kint, List<double> greenAreas, List<double> achievedPercentages)
        {
